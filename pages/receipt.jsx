        ...
        <div>
            <table className="mx-auto text-[12px] border border-gray-300 mt-3">
                <thead>
                    <tr className="bg-gray-100">
                        <th colSpan={2} className="px-4 py-2 text-[15px] bg-[#016252] text-white">{formattedQuery?.name}</th>
            ...
            <div className="flex justify-center">
                <button onClick={handleOpen}
                    ...
                    className="py-1 px-2 font-bold bg-[#016252] text-[10px] rounded-md text-sm text-white mt-5 hover:scale-105 transition-transform disabled:opacity-50"
                    disabled={loading}
                >
                    Get Price
                </button>
                    ...
                    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 ">
                        <div className="bg-white rounded-lg shadow-lg w-full max-w-sm p-6 relative">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <button
                                    type="submit"
                                    className="text-white bg-[#016252] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5"
                                >
